...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  footer{border-top:1px solid var(--line);margin-top:34px;padding:32px 0 46px;text-align:center}
  footer .logo{height:28px;margin:0 auto;display:block}
  footer p{font-size:13px;color:var(--muted);margin-top:12px;line-height:1.8}
  footer .flinks{margin-top:14px;display:flex;gap:8px;justify-content:center;flex-wrap:wrap;
      font-size:13.5px;font-weight:700}
  footer .flinks span{color:#9fb0c6}
...
<footer><div class="wrap">
  ...
  <p>Licensed independent insurance agency &middot; El Paso, Texas<br>
    <a href="tel:+19155031207">915-503-1207</a> &middot; Text <a href="sms:+19155943777">915-594-3777</a><br>
    <a href="mailto:contact@safehouseins.com">contact@safehouseins.com</a></p>
  <p class="flinks"><a href="privacy.html">Privacy Policy</a><span>&middot;</span><a href="sms-terms.html">SMS Terms</a><span>&middot;</span><a href="index.html">Home</a></p>
  <p class="disc">Safe House Insurance is an independent insurance agency licensed in Texas and New Mexico.
    Coverage is subject to carrier approval, underwriting guidelines and the terms, conditions and exclusions
    of the issued policy. &copy; 2026 Safe House Insurance.</p>
</div></footer>
...
Acacia, Dairyland, GAINSCO, Bristol West, Nationwide, Safeco, Allstate, State Farm, and others
...
Progressive, GEICO, Acacia, Dairyland, GAINSCO, Bristol West, Nationwide, Safeco, Allstate, State
Farm y otras &mdash; y con sus agentes generales administradores y suscriptores.</p>
...
for fname, title, h1, desc, body in pages:
    out = head(title, desc, h1, DATES) + fill(body) + FOOT
